...
void mmap_fpga_peripherals() {
    ...
    fpga_switches = h2f_lw_axi_master + DIPSW_PIO_BASE;//Note that the variables are set in the . h file that was created using quartus and the command line commande: generate_..._
